...
def mock_smile_unauth(aioclient_mock: AiohttpClientMocker) -> None:
    """Mock the Plugwise Smile unauthorized for Safegate Pro."""
...
def mock_smile_error(aioclient_mock: AiohttpClientMocker) -> None:
    """Mock the Plugwise Smile server failure for Safegate Pro."""
...
def mock_smile_notconnect():
    """Mock the Plugwise Smile general connection failure for Safegate Pro."""
